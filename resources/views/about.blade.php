     ...
     <section>
          <div class="container">
               <div class="text-center">
                    ...
                    <p class="lead">Car for rent in your budget</p>
               </div>
          </div>
     </section>
          ...
          <div class="container">
               <div class="row">
                    <div class="col-md-offset-1 col-md-4 col-xs-12 pull-right">
                         <img src="{{ asset('car-rental/images/about-1-720x720.jpg')}}" class="img-responsive img-circle" alt="">
                    </div>

                    <div class="col-md-7 col-xs-12">
                         <div class="about-info">
                              <h2>We try our best for your ride</h2>
          ...
          <div class="container">
               <div class="row">
                    <div class="col-md-4 col-xs-12">
                         <img src="{{ asset('car-rental/images/about-2-720x720.jpg')}}" class="img-responsive img-circle" alt="">
                    </div>

                    <div class="col-md-offset-1 col-md-7 col-xs-12">
                         <div class="about-info">
                              <h2>We calm for your holiday</h2>
          ...
          <div class="container">
               <div class="row">
                    <div class="col-md-12 col-sm-12">
                         <div class="text-center">
                              <h2>A passion for your excellency</h2>
